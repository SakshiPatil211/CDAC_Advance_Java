...
<body>
	<form action="/SpringMVCProduct/product/updateproduct" method="post">
		...
		Product cid : <input type="text" name="cid" id="cid" value=${prod.cid} readonly><br>
		<button type="submit" id="save" name="save" value="save">Update Product</button>
	</form>
</body>
</html>